    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950">
      ...
      <header className="border-b bg-white dark:bg-slate-900 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-4 flex flex-col items-center gap-1">
          ...
          {/* Tagline */}
          <p className="text-sm md:text-base font-semibold tracking-wide uppercase -mt-2" style={{ color: '#7C3AED' }}>
            INTELLIGENT RESEARCH FOR TODAY'S EDUCATOR
          </p>
          
          {/* Navigation */}
          <nav className="flex items-center gap-4 md:gap-8 text-sm font-medium text-slate-700 dark:text-slate-300 mt-4">
            <button 
