...
export default function Home() {
  ...
  const downloadResponseAsPdf = (content: string) => {
    ...
    let cleanContent = content
      ...
      .replace(/Feel free[^.?!]*[.?!]?/gi, "")
      .replace(/Is there anything[^.?!]*[.?!]?/gi, "")
      .replace(/Just say[^.?!]*[.?!]?/gi, "")
      .replace(/If you need[^.?!]*[.?!]?/gi, "")
      .replace(/If you want[^.?!]*[.?!]?/gi, "")
      .replace(/If you'd like[^.?!]*[.?!]?/gi, "")
      .replace(/Do you want[^.?!]*[.?!]?/gi, "")
      .replace(/Should I[^.?!]*[.?!]?/gi, "")
      .replace(/What grade level[^.?!]*[.?!]?/gi, "")
      .replace(/What subject[^.?!]*[.?!]?/gi, "")
      .replace(/Your materials are[^.?!]*[.?!]?/gi, "")
      .replace(/These materials are[^.?!]*[.?!]?/gi, "")
      .replace(/This is ready[^.?!]*[.?!]?/gi, "")
      .replace(/I hope this[^.?!]*[.?!]?/gi, "")
      .replace(/Happy teaching[^.?!]*[.?!]?/gi, "")
      .replace(/Good luck[^.?!]*[.?!]?/gi, "")
      .replace(/Best of luck[^.?!]*[.?!]?/gi, "")
      .replace(/ready for printing[^.?!]*[.?!]?/gi, "")
      .replace(/ready for digital[^.?!]*[.?!]?/gi, "")
      .replace(/ready to use[^.?!]*[.?!]?/gi, "")
      .replace(/ready to go[^.?!]*[.?!]?/gi, "")
      .replace(/Can I help[^.?!]*[.?!]?/gi, "")
      .replace(/Shall I[^.?!]*[.?!]?/gi, "")
